...
public class BotState
{
    ...
    public BotState(int botNumber)
    {
        ...
        charState.Add(new CharacterState(new CopyMovement(null, new Vector3(0,0,0), new Quaternion(), Constants.canMoveState, 0, false, 0, WeaponType.sword, 0))); // add one so dont have to do length > 0 all the time
    }
